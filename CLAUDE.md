# coefont-copy - Claude Code Context

---

## 🔺 最上位原理 (Supreme Agent Principle)
...
| θ | 機能 | 適用 |
|---|------|------|
| **Learn** | 学習 | 環境・データから知識獲得 |
| **Integrate** | 統合 | 複数情報源の統一処理 |
| **Execute** | 実行 | 計画→アクション変換 |
| **Allocate** | 配分 | リソース最適配分（メモリ65%制限） |
| **Generate** | 生成 | コード・ドキュメント・解決策創出 |
| **Understand** | 理解 | Intent/World深層把握 |

**詳細**: [AGENT_PRINCIPLE.md](./AGENT_PRINCIPLE.md)

---

## プロジェクト概要

**coefont-copy** - Miyabiフレームワークで構築された自律型開発プロジェクト
